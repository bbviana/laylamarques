...
class ItemList  extends Component {
    _openLightbox = (index) => this.refs.lightbox.open(index)
    ...
    render = (styles = this.styles, {items} = this.props) => {
        ...
        items.forEach((item, i) => {
            ...
            itemsElements.push(
                <div style={styles.item} key={i} onClick={this._openLightbox.bind(this, i)}>
                    <Img src={item}/>
                </div>
            )
        });
...
export default Fetcher.wrap(ItemList)
