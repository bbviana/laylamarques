...
var Menu = React.createClass({
    ...
    componentWillMount(){
        console.log("%cMenu:componentWillMount", "color:red");
    },
...
var LinkMenu = React.createClass({
    render() {
        ...
        return <a className="menu-title"  href={"/items/category/" + item.id}>{item.name}</a>
    }
});

// estilos em app.css

module.exports = require('utils/Fetcher').wrap(Menu);
